                                ...
                                <div class="row">
                                    ...
                                    <div class="col-lg-6 mb-3">
                                        <div class="form-group">
                                            ...
                                            <input name="titre" type="text" class="form-control" value="{{ $post->titre }}">
                                            @if ($errors->has('titre'))
                                ...
                                <div class="row">
                                    <div class="col-lg-12 mb-3">
                                        <div class="form-group">
                                            ...
                                            <textarea name="description" type="textarea" class="form-control"  value="{{ $post->description }}"></textarea>
                                ...
                                <div class="row">
                                    <div class="col-lg-12 mb-3">
                                        <div class="form-group">
                                            ...
                                            <img src="/images/{{ $post->image }}" width="300px" class="mt-2">
